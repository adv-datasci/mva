...
est.time.distance <-function(address,commute,dep.date,dep.time){
  ...
  ori<-paste(address.1$lat, address.1$lon,sep = "+")
...
d<-est.time.distance(address="929 North Wolfe Street, MD 21209",commute="driving",dep.date="2017-12-12",dep.time="23:40:00")
#coordinate of the address :Latitude(39.301224),Longitude(-76.590923)

address.1=as.data.frame(39.301224)
address.1$lon=-76.590923
colnames(address.1)[1]="lat"

save(output.data,file="sample output.RData")